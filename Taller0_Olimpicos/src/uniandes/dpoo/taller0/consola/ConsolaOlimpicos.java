...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le pide al usuario el nombre de un atleta para buscar que pais representa
	 */
	private void ejecutarPaisAtleta()
	{
		...
		{
			System.out.println("No se encontro el pais del atleta " + atleta);
		}
	...
	private void ejecutarMejorPaisEnUnEvento()
	{
		...
		else if (mejores.size() == 1)
		{
			...
			System.out.println(
					"Ha ganado: " + medallas[0] + " oros, " + medallas[1] + " platas, " + medallas[2] + " bronces.");
		}
		else
		{
